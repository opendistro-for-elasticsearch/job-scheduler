...
import com.amazon.opendistroforelasticsearch.jobscheduler.scheduler.ScheduledJobInfo;
...
public class TransportGetJobAction extends HandledTransportAction<GetJobRequest, GetJobResponse> {
    ...
    @Inject
    public TransportGetJobAction(TransportService transportService, Client client, ActionFilters actionFilters, JobScheduler jobScheduler){
